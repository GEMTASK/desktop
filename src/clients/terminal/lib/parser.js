...
function peg$parse(input, options) {
  ...
  const peg$e3 = peg$otherExpectation("number");
  const peg$e4 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e5 = peg$literalExpectation(".", false);
  const peg$e6 = peg$otherExpectation("identifier");
  const peg$e7 = peg$classExpectation(["_", ["a", "z"], ["A", "Z"]], false, false, false);
  const peg$e8 = peg$classExpectation(["_", ["a", "z"], ["A", "Z"], ["0", "9"]], false, false, false);
